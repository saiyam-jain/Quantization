...
def create_model():
    ...
    tf_model.add(tf.keras.layers.Conv2D(64, (3, 3), activation='tanh', input_shape=shape))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Conv2D(64, (3, 3), activation='tanh'))
    tf_model.add(tf.keras.layers.MaxPool2D(2, 2))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Conv2D(128, (3, 3), activation='tanh'))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Conv2D(128, (3, 3), activation='tanh'))
    tf_model.add(tf.keras.layers.MaxPool2D(2, 2))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Conv2D(256, (3, 3), activation='tanh'))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Conv2D(256, (3, 3), activation='tanh'))
    tf_model.add(tf.keras.layers.MaxPool2D(2, 2))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Conv2D(512, (3, 3), activation='tanh'))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Conv2D(512, (3, 3), activation='tanh'))
    tf_model.add(tf.keras.layers.MaxPool2D(2, 2))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Flatten())
    tf_model.add(tf.keras.layers.Dense(1024, activation='tanh'))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Dense(512, activation='tanh'))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Dense(256, activation='tanh'))
    tf_model.add(tf.keras.layers.BatchNormalization(momentum=0.999, scale=False))
    tf_model.add(tf.keras.layers.Dense(2, activation='sigmoid'))
